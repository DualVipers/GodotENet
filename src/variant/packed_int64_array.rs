...
pub struct PackedInt64Array(pub Vec<i64>);

impl Variant for PackedInt64Array {
        ...
        Self: Sized,
    {
        ...
        for i in 0..count {
            data[i] = helpers::parse_i64(&raw_bytes[consumed..(consumed + 8)]);
...
impl std::ops::Deref for PackedInt64Array {
    type Target = Vec<i64>;
